(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(t){if(t.ep)return;t.ep=!0;const o=s(t);fetch(t.href,o)}})();const M="modulepreload",A=function(a,r){return new URL(a,r).href},f={},P=function(r,s,e){let t=Promise.resolve();if(s&&s.length>0){const i=document.getElementsByTagName("link"),u=document.querySelector("meta[property=csp-nonce]"),n=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));t=Promise.allSettled(s.map(c=>{if(c=A(c,e),c in f)return;f[c]=!0;const p=c.endsWith(".css"),l=p?'[rel="stylesheet"]':"";if(!!e)for(let h=i.length-1;h>=0;h--){const v=i[h];if(v.href===c&&(!p||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${l}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":M,p||(m.as="script"),m.crossOrigin="",m.href=c,n&&m.setAttribute("nonce",n),document.head.appendChild(m),p)return new Promise((h,v)=>{m.addEventListener("load",h),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(i){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=i,window.dispatchEvent(u),!u.defaultPrevented)throw i}return t.then(i=>{for(const u of i||[])u.status==="rejected"&&o(u.reason);return r().catch(o)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const I="modulepreload",T=function(a,r){return new URL(a,r).href},g={},B=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=T(n,s),n in g)return;g[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":I,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const q="modulepreload",j=function(a,r){return new URL(a,r).href},x={},z=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=j(n,s),n in x)return;x[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":q,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const O="modulepreload",D=function(a,r){return new URL(a,r).href},b={},$=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=D(n,s),n in b)return;b[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":O,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const H="modulepreload",N=function(a,r){return new URL(a,r).href},y={},R=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=N(n,s),n in y)return;y[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":H,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const U="modulepreload",V=function(a,r){return new URL(a,r).href},w={},G=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=V(n,s),n in w)return;w[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":U,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const K="modulepreload",_=function(a,r){return new URL(a,r).href},k={},W=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=_(n,s),n in k)return;k[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":K,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const F="modulepreload",Q=function(a,r){return new URL(a,r).href},E={},Y=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=Q(n,s),n in E)return;E[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":F,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const J="modulepreload",X=function(a,r){return new URL(a,r).href},C={},Z=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=X(n,s),n in C)return;C[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":J,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const ee="modulepreload",te=function(a,r){return new URL(a,r).href},S={},re=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=te(n,s),n in S)return;S[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":ee,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const se="modulepreload",oe=function(a,r){return new URL(a,r).href},L={},ie=function(a,r,s){let e=Promise.resolve();if(r&&r.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),u=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(r.map(n=>{if(n=oe(n,s),n in L)return;L[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(s)for(let d=o.length-1;d>=0;d--){const m=o[d];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":se,c||(l.as="script"),l.crossOrigin="",l.href=n,u&&l.setAttribute("nonce",u),document.head.appendChild(l),c)return new Promise((d,m)=>{l.addEventListener("load",d),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&t(i.reason);return a().catch(t)})};class ne extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const r=this.querySelector("#mobileMenuBtn"),s=this.querySelector("#mobileMenu");r&&s&&r.addEventListener("click",()=>{s.classList.toggle("hidden")}),document.addEventListener("click",e=>{s&&!this.contains(e.target)&&!s.classList.contains("hidden")&&s.classList.add("hidden")})}}customElements.define("header-component",ne);class ae extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const r=this.querySelector("#dashboardCtaBtn");r&&r.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const r=(i,u)=>Math.floor(Math.random()*(u-i+1))+i,s=this.querySelector("#activeUsers"),e=this.querySelector("#activeCampaigns"),t=this.querySelector("#conversions"),o=this.querySelector("#revenue");if(s){const i=(parseInt(s.textContent.replace(",",""))||2847)+r(-2,5);s.textContent=i.toLocaleString()}if(e){const i=(parseInt(e.textContent)||47)+r(-1,1);e.textContent=Math.max(45,i)}if(t){const i=(parseInt(t.textContent.replace(",",""))||1284)+r(1,8);t.textContent=i.toLocaleString()}if(o){const i=parseFloat(o.textContent.replace("$","").replace("K",""))||24.7,u=r(1,3)/10,n=i+u;o.textContent=`$${n.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((r,s)=>{setTimeout(()=>{r.style.transition="height 1s ease-in-out"},s*100)})},500)}setupIntersectionObserver(){const r=new IntersectionObserver(s=>{s.forEach(e=>{e.isIntersecting&&(e.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(s=>r.observe(s))},100)}}customElements.define("dashboard-section",ce);class de extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const r=this.querySelector("#prevTestimonial"),s=this.querySelector("#nextTestimonial"),e=this.querySelectorAll(".testimonial-dot"),t=this.querySelector("#premiumCtaBtn"),o=this.querySelector("#essentialCtaBtn");r&&r.addEventListener("click",()=>this.previousTestimonial()),s&&s.addEventListener("click",()=>this.nextTestimonial()),e.forEach(i=>{i.addEventListener("click",u=>{const n=parseInt(u.target.dataset.index);this.goToTestimonial(n)})}),t&&t.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")}),o&&o.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(r){r>=0&&r<3&&(this.currentTestimonial=r,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const r=this.querySelector("#testimonialContent"),s=this.querySelectorAll(".testimonial-dot");if(r){const e=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];r.innerHTML=`
            ...
            `}s.forEach((e,t)=>{t===this.currentTestimonial?(e.classList.remove("bg-gray-300"),e.classList.add("bg-primary-blue")):(e.classList.remove("bg-primary-blue"),e.classList.add("bg-gray-300"))})}}customElements.define("club-section",de);class ue extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
