(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function e(r){if(r.ep)return;r.ep=!0;const a=s(r);fetch(r.href,a)}})();const k="modulepreload",C=function(n,t){return new URL(n,t).href},g={},E=function(t,s,e){let r=Promise.resolve();if(s&&s.length>0){const i=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),o=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));r=Promise.allSettled(s.map(d=>{if(d=C(d,e),d in g)return;g[d]=!0;const p=d.endsWith(".css"),l=p?'[rel="stylesheet"]':"";if(!!e)for(let h=i.length-1;h>=0;h--){const v=i[h];if(v.href===d&&(!p||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${l}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":k,p||(u.as="script"),u.crossOrigin="",u.href=d,o&&u.setAttribute("nonce",o),document.head.appendChild(u),p)return new Promise((h,v)=>{u.addEventListener("load",h),u.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(i){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=i,window.dispatchEvent(c),!c.defaultPrevented)throw i}return r.then(i=>{for(const c of i||[])c.status==="rejected"&&a(c.reason);return t().catch(a)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const S="modulepreload",L=function(n,t){return new URL(n,t).href},x={},M=function(n,t,s){let e=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(o=>{if(o=L(o,s),o in x)return;x[o]=!0;const d=o.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(s)for(let m=a.length-1;m>=0;m--){const u=a[m];if(u.href===o&&(!d||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":S,d||(l.as="script"),l.crossOrigin="",l.href=o,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((m,u)=>{l.addEventListener("load",m),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return e.then(a=>{for(const i of a||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const I="modulepreload",A=function(n,t){return new URL(n,t).href},f={},T=function(n,t,s){let e=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(o=>{if(o=A(o,s),o in f)return;f[o]=!0;const d=o.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(s)for(let m=a.length-1;m>=0;m--){const u=a[m];if(u.href===o&&(!d||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":I,d||(l.as="script"),l.crossOrigin="",l.href=o,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((m,u)=>{l.addEventListener("load",m),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return e.then(a=>{for(const i of a||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const P="modulepreload",B=function(n,t){return new URL(n,t).href},b={},z=function(n,t,s){let e=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(o=>{if(o=B(o,s),o in b)return;b[o]=!0;const d=o.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(s)for(let m=a.length-1;m>=0;m--){const u=a[m];if(u.href===o&&(!d||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":P,d||(l.as="script"),l.crossOrigin="",l.href=o,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((m,u)=>{l.addEventListener("load",m),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return e.then(a=>{for(const i of a||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const j="modulepreload",q=function(n,t){return new URL(n,t).href},y={},D=function(n,t,s){let e=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(o=>{if(o=q(o,s),o in y)return;y[o]=!0;const d=o.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(s)for(let m=a.length-1;m>=0;m--){const u=a[m];if(u.href===o&&(!d||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":j,d||(l.as="script"),l.crossOrigin="",l.href=o,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((m,u)=>{l.addEventListener("load",m),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return e.then(a=>{for(const i of a||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const H="modulepreload",O=function(n,t){return new URL(n,t).href},w={},$=function(n,t,s){let e=Promise.resolve();if(t&&t.length>0){const a=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),c=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(o=>{if(o=O(o,s),o in w)return;w[o]=!0;const d=o.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(s)for(let m=a.length-1;m>=0;m--){const u=a[m];if(u.href===o&&(!d||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":H,d||(l.as="script"),l.crossOrigin="",l.href=o,c&&l.setAttribute("nonce",c),document.head.appendChild(l),d)return new Promise((m,u)=>{l.addEventListener("load",m),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function r(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return e.then(a=>{for(const i of a||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})};class N extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const t=this.querySelector("#mobileMenuBtn"),s=this.querySelector("#mobileMenu");t&&s&&t.addEventListener("click",()=>{s.classList.toggle("hidden")}),document.addEventListener("click",e=>{s&&!this.contains(e.target)&&!s.classList.contains("hidden")&&s.classList.add("hidden")})}}customElements.define("header-component",N);class R extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const t=this.querySelector("#dashboardCtaBtn");t&&t.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const t=(i,c)=>Math.floor(Math.random()*(c-i+1))+i,s=this.querySelector("#activeUsers"),e=this.querySelector("#activeCampaigns"),r=this.querySelector("#conversions"),a=this.querySelector("#revenue");if(s){const i=(parseInt(s.textContent.replace(",",""))||2847)+t(-2,5);s.textContent=i.toLocaleString()}if(e){const i=(parseInt(e.textContent)||47)+t(-1,1);e.textContent=Math.max(45,i)}if(r){const i=(parseInt(r.textContent.replace(",",""))||1284)+t(1,8);r.textContent=i.toLocaleString()}if(a){const i=parseFloat(a.textContent.replace("$","").replace("K",""))||24.7,c=t(1,3)/10,o=i+c;a.textContent=`$${o.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((t,s)=>{setTimeout(()=>{t.style.transition="height 1s ease-in-out"},s*100)})},500)}setupIntersectionObserver(){const t=new IntersectionObserver(s=>{s.forEach(e=>{e.isIntersecting&&(e.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(s=>t.observe(s))},100)}}customElements.define("dashboard-section",U);class G extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const t=this.querySelector("#prevTestimonial"),s=this.querySelector("#nextTestimonial"),e=this.querySelectorAll(".testimonial-dot"),r=this.querySelector("#premiumCtaBtn"),a=this.querySelector("#essentialCtaBtn");t&&t.addEventListener("click",()=>this.previousTestimonial()),s&&s.addEventListener("click",()=>this.nextTestimonial()),e.forEach(i=>{i.addEventListener("click",c=>{const o=parseInt(c.target.dataset.index);this.goToTestimonial(o)})}),r&&r.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")}),a&&a.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(t){t>=0&&t<3&&(this.currentTestimonial=t,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const t=this.querySelector("#testimonialContent"),s=this.querySelectorAll(".testimonial-dot");if(t){const e=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];t.innerHTML=`
                <div class="text-center">
                    <div class="text-6xl mb-4">"</div>
                    <p class="text-xl text-gray-700 mb-6 italic">
                        ${e.text}
            ...
            `}s.forEach((e,r)=>{r===this.currentTestimonial?(e.classList.remove("bg-gray-300"),e.classList.add("bg-primary-blue")):(e.classList.remove("bg-primary-blue"),e.classList.add("bg-gray-300"))})}}customElements.define("club-section",G);class _ extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
...
---`}}showLoading(t){const s=this.querySelector("#loadingState"),e=this.querySelector("#generateBtn");t?(s.classList.remove("hidden"),e.disabled=!0,e.textContent="Generando..."):(s.classList.add("hidden"),e.disabled=!1,e.textContent="Generar Descripción ✨")}showResult(t){const s=this.querySelector("#resultSection"),e=this.querySelector("#generatedContent pre");e.textContent=t,s.classList.remove("hidden"),s.scrollIntoView({behavior:"smooth",block:"nearest"})}async copyToClipboard(){try{await navigator.clipboard.writeText(this.generatedDescription),this.showCopySuccess()}catch(t){console.error("Error copying to clipboard:",t);const s=document.createElement("textarea");s.value=this.generatedDescription,document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),this.showCopySuccess()}}showCopySuccess(){const t=this.querySelector("#copySuccess");t.classList.remove("hidden"),setTimeout(()=>{t.classList.add("hidden")},3e3)}showNotification(t,s="info"){const e=document.createElement("div"),r={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};e.className=`fixed top-4 right-4 ${r[s]} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 translate-x-0`,e.textContent=t,document.body.appendChild(e),setTimeout(()=>{e.style.transform="translateX(100%)",setTimeout(()=>e.remove(),300)},3e3)}}customElements.define("instagram-description-component",_);class K extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupAnimations()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){this.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const e=t.getAttribute("href").substring(1),r=document.getElementById(e);r&&r.scrollIntoView({behavior:"smooth",block:"start"})})}),this.querySelectorAll("[data-service]").forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const e=t.getAttribute("data-service");let r="";switch(e){case"ia":r="Hola! Me interesa su Asistente IA. ¿Podemos hablar sobre cómo implementar inteligencia artificial en mi negocio?";break;case"bots":r="Hola! Quiero conocer más sobre sus Bots Omnicanal. ¿Cómo pueden ayudarme con la automatización de atención al cliente?";break;case"campanas":r="Hola! Me gustaría saber más sobre sus Campañas Garantizadas. ¿Cómo funcionan y cuáles son los resultados esperados?";break;case"growth":r="Hola! El Growth Simulator me parece muy interesante. ¿Podemos discutir cómo simular el crecimiento de mi negocio?";break;default:r="Hola! Me gustaría obtener más información sobre sus servicios."}const a=encodeURIComponent(r);window.open(`https://wa.me/542923560623?text=${a}`,"_blank")})})}}customElements.define("footer-component",W);class F extends HTMLElement{constructor(){super(),this.isOpen=!1,this.conversation=[],this.isTyping=!1}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
...
Responde como representante oficial de Boom Digital Agency, manteniendo un tono profesional pero cercano.`,a=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Eres un asistente profesional de Boom Digital Agency, especializado en soluciones de IA y transformación digital. Responde siempre en español de manera clara y útil."},{role:"user",content:r}],max_tokens:500,temperature:.7})});if(!a.ok)throw new Error(`API error: ${a.status}`);return(await a.json()).choices[0].message.content}showTypingIndicator(){this.querySelector("#typingIndicator").classList.remove("hidden"),this.scrollToBottom()}hideTypingIndicator(){this.querySelector("#typingIndicator").classList.add("hidden")}scrollToBottom(){const t=this.querySelector("#messagesContainer");t.scrollTop=t.scrollHeight}updateSendButtonState(){const t=this.querySelector("#sendMessage"),s=this.querySelector("#messageInput");t.disabled=!s.value.trim()||this.isTyping}escapeHtml(t){const s=document.createElement("div");return s.textContent=t,s.innerHTML}formatMessage(t){return t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="text-primary-blue underline">$1</a>')}}customElements.define("chat-bot",F);class Q{constructor(){this.init()}init(){console.log("Boom Digital Agency - Application Started"),this.setupScrollAnimations(),this.setupLazyLoading(),this.trackPageView()}setupScrollAnimations(){const t={threshold:.1,rootMargin:"0px 0px -50px 0px"},s=new IntersectionObserver(e=>{e.forEach(r=>{r.isIntersecting&&r.target.classList.add("animate-fade-in","animate-slide-up")})},t);document.querySelectorAll("section, .animate-on-scroll").forEach(e=>{s.observe(e)})}setupLazyLoading(){const t=new IntersectionObserver((s,e)=>{s.forEach(r=>{if(r.isIntersecting){const a=r.target;a.src=a.dataset.src,a.classList.remove("lazy"),e.unobserve(a)}})});document.querySelectorAll("img[data-src]").forEach(s=>{t.observe(s)})}async trackPageView(){try{const{trackPageView:t}=await $(async()=>{const{trackPageView:s}=await D(()=>z(()=>T(()=>M(()=>E(()=>import("./firebase-6dUurx0Q-BXuLB0tj-CkyGTK-u-_ub-MjIu-Dsa3sb0U-BITRcsr3.js"),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url);return{trackPageView:s}},[],import.meta.url);await t("home")}catch{console.log("Analytics tracking not available in development")}}}document.addEventListener("DOMContentLoaded",()=>{new Q});
