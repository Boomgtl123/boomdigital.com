(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=t(a);fetch(a.href,i)}})();const b="modulepreload",f=function(n,e){return new URL(n,e).href},x={},y=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(t.map(l=>{if(l=f(l,s),l in x)return;x[l]=!0;const d=l.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(!!s)for(let u=o.length-1;u>=0;u--){const p=o[u];if(p.href===l&&(!d||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${g}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":b,d||(m.as="script"),m.crossOrigin="",m.href=l,c&&m.setAttribute("nonce",c),document.head.appendChild(m),d)return new Promise((u,p)=>{m.addEventListener("load",u),m.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return a.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};class w extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#mobileMenuBtn"),t=this.querySelector("#mobileMenu");e&&t&&e.addEventListener("click",()=>{t.classList.toggle("hidden")}),document.addEventListener("click",s=>{t&&!this.contains(s.target)&&!t.classList.contains("hidden")&&t.classList.add("hidden")})}}customElements.define("header-component",w);class k extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const e=this.querySelector("#dashboardCtaBtn");e&&e.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const e=(o,r)=>Math.floor(Math.random()*(r-o+1))+o,t=this.querySelector("#activeUsers"),s=this.querySelector("#activeCampaigns"),a=this.querySelector("#conversions"),i=this.querySelector("#revenue");if(t){const r=(parseInt(t.textContent.replace(",",""))||2847)+e(-2,5);t.textContent=r.toLocaleString()}if(s){const r=(parseInt(s.textContent)||47)+e(-1,1);s.textContent=Math.max(45,r)}if(a){const r=(parseInt(a.textContent.replace(",",""))||1284)+e(1,8);a.textContent=r.toLocaleString()}if(i){const o=parseFloat(i.textContent.replace("$","").replace("K",""))||24.7,r=e(1,3)/10,c=o+r;i.textContent=`$${c.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((t,s)=>{setTimeout(()=>{t.style.transition="height 1s ease-in-out"},s*100)})},500)}setupIntersectionObserver(){const e=new IntersectionObserver(t=>{t.forEach(s=>{s.isIntersecting&&(s.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(s=>e.observe(s))},100)}}customElements.define("dashboard-section",E);class M extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#prevTestimonial"),t=this.querySelector("#nextTestimonial"),s=this.querySelectorAll(".testimonial-dot"),a=this.querySelector("#premiumCtaBtn"),i=this.querySelector("#essentialCtaBtn");e&&e.addEventListener("click",()=>this.previousTestimonial()),t&&t.addEventListener("click",()=>this.nextTestimonial()),s.forEach(o=>{o.addEventListener("click",r=>{const c=parseInt(r.target.dataset.index);this.goToTestimonial(c)})}),a&&a.addEventListener("click",()=>{const o=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${o}`,"_blank")}),i&&i.addEventListener("click",()=>{const o=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${o}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(e){e>=0&&e<3&&(this.currentTestimonial=e,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const e=this.querySelector("#testimonialContent"),t=this.querySelectorAll(".testimonial-dot");if(e){const a=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];e.innerHTML=`
                <div class="text-center">
                    <div class="text-6xl mb-4">"</div>
                    <p class="text-xl text-gray-700 mb-6 italic">
                        ${a.text}
            ...
            `}t.forEach((s,a)=>{a===this.currentTestimonial?(s.classList.remove("bg-gray-300"),s.classList.add("bg-primary-blue")):(s.classList.remove("bg-primary-blue"),s.classList.add("bg-gray-300"))})}}customElements.define("club-section",M);var h={};class S extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
...
Piensa primero, luego genera la descripción optimizada para Instagram.`},{role:"user",content:`Investiga y genera una descripción optimizada para Instagram del producto: ${e}. Incluye información real sobre qué es este producto, su contexto y características principales.`}],max_tokens:600,temperature:.8})});if(!t.ok)throw new Error(`API request failed: ${t.status}`);const a=(await t.json()).choices[0].message.content.trim();let i="",o="",r="";const c=a.match(/Título:\s*(.+?)(?:\n|$)/i);c&&(i=c[1].trim());const l=a.match(/Descripción:\s*(.+?)(?:\nHashtags:|$)/is);l&&(o=l[1].trim());const d=a.match(/Hashtags:\s*(.+?)(?:\n|$)/is);return d&&(r=d[1].trim()),(!i||!o)&&(o=a,i=`${e} – Descubre la Diferencia`,r="#Innovacion2025 #ProductoPremium #CalidadSuperior"),`---
Título: ${i}
Descripción: ${o}
Hashtags: ${r}
...
---`}}showLoading(e){const t=this.querySelector("#loadingState"),s=this.querySelector("#generateBtn");e?(t.classList.remove("hidden"),s.disabled=!0,s.textContent="Generando..."):(t.classList.add("hidden"),s.disabled=!1,s.textContent="Generar Descripción ✨")}showResult(e){const t=this.querySelector("#resultSection"),s=this.querySelector("#generatedContent pre");s.textContent=e,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}async copyToClipboard(){try{await navigator.clipboard.writeText(this.generatedDescription),this.showCopySuccess()}catch(e){console.error("Error copying to clipboard:",e);const t=document.createElement("textarea");t.value=this.generatedDescription,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),this.showCopySuccess()}}showCopySuccess(){const e=this.querySelector("#copySuccess");e.classList.remove("hidden"),setTimeout(()=>{e.classList.add("hidden")},3e3)}showNotification(e,t="info"){const s=document.createElement("div"),a={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`fixed top-4 right-4 ${a[t]} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 translate-x-0`,s.textContent=e,document.body.appendChild(s),setTimeout(()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),300)},3e3)}}customElements.define("instagram-description-component",S);class I extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupAnimations()}render(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const e=this.querySelector(".cta-primary");e&&e.addEventListener("click",()=>{this.handlePrimaryCTA()});const t=this.querySelector(".cta-secondary");t&&t.addEventListener("click",()=>{this.handleSecondaryCTA()})}setupAnimations(){this.querySelectorAll(".animate-slide-up").forEach((t,s)=>{t.style.animationDelay=`${s*200}ms`}),this.animateFloatingElements()}animateFloatingElements(){this.querySelectorAll(".floating-element-1, .floating-element-2, .floating-element-3").forEach((t,s)=>{if(t.style.animation=`float 6s ease-in-out infinite ${s*2}s`,!document.querySelector("#floatingKeyframes")){const a=document.createElement("style");a.id="floatingKeyframes",a.textContent=`
                    @keyframes float {
                        0%, 100% { transform: translateY(0px) rotate(0deg); }
                        50% { transform: translateY(-20px) rotate(180deg); }
                    }
                `,document.head.appendChild(a)}})}handlePrimaryCTA(){const e=encodeURIComponent("Hola! Quiero comenzar con sus servicios de IA y automatización. ¿Podemos hablar sobre cómo transformar mi negocio?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}handleSecondaryCTA(){const e=encodeURIComponent("Hola! Me gustaría agendar una demo gratuita para conocer sus soluciones de IA. ¿Cuándo podríamos tener una reunión?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}updateCTAContent(e){if(e.title){const t=this.querySelector("h2");t&&(t.textContent=e.title)}if(e.subtitle){const t=this.querySelector("p.text-gray-300");t&&(t.textContent=e.subtitle)}if(e.primaryButton){const t=this.querySelector(".cta-primary span");t&&(t.textContent=e.primaryButton)}if(e.secondaryButton){const t=this.querySelector(".cta-secondary");t&&(t.textContent=e.secondaryButton)}}}customElements.define("cta-section",I);class L extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){this.querySelectorAll('a[href^="#"]').forEach(s=>{s.addEventListener("click",a=>{a.preventDefault();const i=s.getAttribute("href").substring(1),o=document.getElementById(i);o&&o.scrollIntoView({behavior:"smooth",block:"start"})})}),this.querySelectorAll("[data-service]").forEach(s=>{s.addEventListener("click",a=>{a.preventDefault();const i=s.getAttribute("data-service");let o="";switch(i){case"ia":o="Hola! Me interesa su Asistente IA. ¿Podemos hablar sobre cómo implementar inteligencia artificial en mi negocio?";break;case"bots":o="Hola! Quiero conocer más sobre sus Bots Omnicanal. ¿Cómo pueden ayudarme con la automatización de atención al cliente?";break;case"campanas":o="Hola! Me gustaría saber más sobre sus Campañas Garantizadas. ¿Cómo funcionan y cuáles son los resultados esperados?";break;case"growth":o="Hola! El Growth Simulator me parece muy interesante. ¿Podemos discutir cómo simular el crecimiento de mi negocio?";break;default:o="Hola! Me gustaría obtener más información sobre sus servicios."}const r=encodeURIComponent(o);window.open(`https://wa.me/542923560623?text=${r}`,"_blank")})})}}customElements.define("footer-component",L);var v={};class T extends HTMLElement{constructor(){super(),this.isOpen=!1,this.conversation=[],this.isTyping=!1}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
