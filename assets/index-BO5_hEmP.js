(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=t(a);fetch(a.href,i)}})();const y="modulepreload",w=function(n,e){return new URL(n,e).href},b={},k=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){const r=document.getElementsByTagName("link"),o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));a=Promise.allSettled(t.map(c=>{if(c=w(c,s),c in b)return;b[c]=!0;const u=c.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(!!s)for(let h=r.length-1;h>=0;h--){const v=r[h];if(v.href===c&&(!u||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${m}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":y,u||(d.as="script"),d.crossOrigin="",d.href=c,l&&d.setAttribute("nonce",l),document.head.appendChild(d),u)return new Promise((h,v)=>{d.addEventListener("load",h),d.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(r){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r}return a.then(r=>{for(const o of r||[])o.status==="rejected"&&i(o.reason);return e().catch(i)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();const C="modulepreload",E=function(n,e){return new URL(n,e).href},f={},M=function(n,e,t){let s=Promise.resolve();if(e&&e.length>0){const i=document.getElementsByTagName("link"),r=document.querySelector("meta[property=csp-nonce]"),o=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.allSettled(e.map(l=>{if(l=E(l,t),l in f)return;f[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(t)for(let p=i.length-1;p>=0;p--){const d=i[p];if(d.href===l&&(!c||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${u}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":C,c||(m.as="script"),m.crossOrigin="",m.href=l,o&&m.setAttribute("nonce",o),document.head.appendChild(m),c)return new Promise((p,d)=>{m.addEventListener("load",p),m.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return s.then(i=>{for(const r of i||[])r.status==="rejected"&&a(r.reason);return n().catch(a)})};class S extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#mobileMenuBtn"),t=this.querySelector("#mobileMenu");e&&t&&e.addEventListener("click",()=>{t.classList.toggle("hidden")}),document.addEventListener("click",s=>{t&&!this.contains(s.target)&&!t.classList.contains("hidden")&&t.classList.add("hidden")})}}customElements.define("header-component",S);class L extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const e=this.querySelector("#dashboardCtaBtn");e&&e.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const e=(r,o)=>Math.floor(Math.random()*(o-r+1))+r,t=this.querySelector("#activeUsers"),s=this.querySelector("#activeCampaigns"),a=this.querySelector("#conversions"),i=this.querySelector("#revenue");if(t){const r=(parseInt(t.textContent.replace(",",""))||2847)+e(-2,5);t.textContent=r.toLocaleString()}if(s){const r=(parseInt(s.textContent)||47)+e(-1,1);s.textContent=Math.max(45,r)}if(a){const r=(parseInt(a.textContent.replace(",",""))||1284)+e(1,8);a.textContent=r.toLocaleString()}if(i){const r=parseFloat(i.textContent.replace("$","").replace("K",""))||24.7,o=e(1,3)/10,l=r+o;i.textContent=`$${l.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((e,t)=>{setTimeout(()=>{e.style.transition="height 1s ease-in-out"},t*100)})},500)}setupIntersectionObserver(){const e=new IntersectionObserver(t=>{t.forEach(s=>{s.isIntersecting&&(s.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(t=>e.observe(t))},100)}}customElements.define("dashboard-section",T);class A extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#prevTestimonial"),t=this.querySelector("#nextTestimonial"),s=this.querySelectorAll(".testimonial-dot"),a=this.querySelector("#premiumCtaBtn"),i=this.querySelector("#essentialCtaBtn");e&&e.addEventListener("click",()=>this.previousTestimonial()),t&&t.addEventListener("click",()=>this.nextTestimonial()),s.forEach(r=>{r.addEventListener("click",o=>{const l=parseInt(o.target.dataset.index);this.goToTestimonial(l)})}),a&&a.addEventListener("click",()=>{const r=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${r}`,"_blank")}),i&&i.addEventListener("click",()=>{const r=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${r}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(e){e>=0&&e<3&&(this.currentTestimonial=e,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const e=this.querySelector("#testimonialContent"),t=this.querySelectorAll(".testimonial-dot");if(e){const s=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];e.innerHTML=`
                <div class="text-center">
                    <div class="text-6xl mb-4">"</div>
                    <p class="text-xl text-gray-700 mb-6 italic">
                        ${s.text}
            ...
            `}t.forEach((s,a)=>{a===this.currentTestimonial?(s.classList.remove("bg-gray-300"),s.classList.add("bg-primary-blue")):(s.classList.remove("bg-primary-blue"),s.classList.add("bg-gray-300"))})}}customElements.define("club-section",A);var x={};class B extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
...
---`}}showLoading(e){const t=this.querySelector("#loadingState"),s=this.querySelector("#generateBtn");e?(t.classList.remove("hidden"),s.disabled=!0,s.textContent="Generando..."):(t.classList.add("hidden"),s.disabled=!1,s.textContent="Generar Descripción ✨")}showResult(e){const t=this.querySelector("#resultSection"),s=this.querySelector("#generatedContent pre");s.textContent=e,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}async copyToClipboard(){try{await navigator.clipboard.writeText(this.generatedDescription),this.showCopySuccess()}catch(e){console.error("Error copying to clipboard:",e);const t=document.createElement("textarea");t.value=this.generatedDescription,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),this.showCopySuccess()}}showCopySuccess(){const e=this.querySelector("#copySuccess");e.classList.remove("hidden"),setTimeout(()=>{e.classList.add("hidden")},3e3)}showNotification(e,t="info"){const s=document.createElement("div"),a={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`fixed top-4 right-4 ${a[t]} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 translate-x-0`,s.textContent=e,document.body.appendChild(s),setTimeout(()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),300)},3e3)}}customElements.define("instagram-description-component",B);class z extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupAnimations()}render(){this.innerHTML=`
    ...
    `}setupEventListeners(){const e=this.querySelector("#chatToggle"),t=this.querySelector("#chatWindow"),s=this.querySelector("#closeChat"),a=this.querySelector("#sendMessage"),i=this.querySelector("#messageInput");e.addEventListener("click",()=>{this.isOpen=!this.isOpen,t.classList.toggle("hidden",!this.isOpen),this.isOpen&&i.focus()}),s.addEventListener("click",()=>{this.isOpen=!1,t.classList.add("hidden")});const r=()=>{const o=i.value.trim();o&&!this.isTyping&&(this.addUserMessage(o),i.value="",this.getAIResponse(o))};a.addEventListener("click",r),i.addEventListener("keypress",o=>{o.key==="Enter"&&r()}),i.addEventListener("input",()=>{a.disabled=!i.value.trim()||this.isTyping})}addUserMessage(e){const t=this.querySelector("#messagesContainer"),s=document.createElement("div");s.className="message user-message bg-primary-blue text-white rounded-lg p-3 shadow-sm mb-3 ml-8",s.innerHTML=`<p class="text-sm">${this.escapeHtml(e)}</p>`,t.appendChild(s),this.scrollToBottom()}addBotMessage(e){const t=this.querySelector("#messagesContainer"),s=document.createElement("div");s.className="message bot-message bg-white rounded-lg p-3 shadow-sm mb-3",s.innerHTML=`<p class="text-sm text-gray-700">${this.formatMessage(e)}</p>`,t.appendChild(s),this.scrollToBottom()}async getAIResponse(e){this.showTypingIndicator(),this.isTyping=!0;try{const t=await this.callDeepSeekAPI(e);this.hideTypingIndicator(),this.addBotMessage(t)}catch(t){console.error("Error calling DeepSeek API:",t),this.hideTypingIndicator(),this.addBotMessage("Lo siento, estoy teniendo problemas para conectarme. Por favor, intenta nuevamente en un momento.")}this.isTyping=!1,this.updateSendButtonState()}getApiKey(){return typeof process<"u"&&g&&g.CHATBOT_API_KEY?g.CHATBOT_API_KEY:"sk-59b0807d89344fb781f3d9b1baf35753"}async callDeepSeekAPI(e){const t=this.getApiKey(),s="https://api.deepseek.com/v1/chat/completions",a=`Eres el asistente oficial de Boom Digital Agency. Responde en español de manera profesional y amigable. 
...
Responde como representante oficial de Boom Digital Agency, manteniendo un tono profesional pero cercano.`,i=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Eres un asistente profesional de Boom Digital Agency, especializado en soluciones de IA y transformación digital. Responde siempre en español de manera clara y útil."},{role:"user",content:a}],max_tokens:500,temperature:.7})});if(!i.ok)throw new Error(`API error: ${i.status}`);return(await i.json()).choices[0].message.content}showTypingIndicator(){this.querySelector("#typingIndicator").classList.remove("hidden"),this.scrollToBottom()}hideTypingIndicator(){this.querySelector("#typingIndicator").classList.add("hidden")}scrollToBottom(){const e=this.querySelector("#messagesContainer");e.scrollTop=e.scrollHeight}updateSendButtonState(){const e=this.querySelector("#sendMessage"),t=this.querySelector("#messageInput");e.disabled=!t.value.trim()||this.isTyping}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}formatMessage(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="text-primary-blue underline">$1</a>')}}customElements.define("chat-bot",P);class q{constructor(){this.init()}init(){console.log("Boom Digital Agency - Application Started"),this.setupScrollAnimations(),this.setupLazyLoading(),this.trackPageView()}setupScrollAnimations(){const e={threshold:.1,rootMargin:"0px 0px -50px 0px"},t=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&a.target.classList.add("animate-fade-in","animate-slide-up")})},e);document.querySelectorAll("section, .animate-on-scroll").forEach(s=>{t.observe(s)})}setupLazyLoading(){const e=new IntersectionObserver((t,s)=>{t.forEach(a=>{if(a.isIntersecting){const i=a.target;i.src=i.dataset.src,i.classList.remove("lazy"),s.unobserve(i)}})});document.querySelectorAll("img[data-src]").forEach(t=>{e.observe(t)})}async trackPageView(){try{const{trackPageView:e}=await M(async()=>{const{trackPageView:t}=await k(()=>import("./firebase-Bw_4rmA1-C7_HaL2c.js"),[],import.meta.url);return{trackPageView:t}},[],import.meta.url);await e("home")}catch{console.log("Analytics tracking not available in development")}}}document.addEventListener("DOMContentLoaded",()=>{new q});
