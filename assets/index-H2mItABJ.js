(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))e(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function r(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(s){if(s.ep)return;s.ep=!0;const o=r(s);fetch(s.href,o)}})();const S="modulepreload",L=function(a,t){return new URL(a,t).href},g={},M=function(t,r,e){let s=Promise.resolve();if(r&&r.length>0){const i=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),n=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));s=Promise.allSettled(r.map(c=>{if(c=L(c,e),c in g)return;g[c]=!0;const p=c.endsWith(".css"),l=p?'[rel="stylesheet"]':"";if(!!e)for(let h=i.length-1;h>=0;h--){const v=i[h];if(v.href===c&&(!p||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${l}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":S,p||(m.as="script"),m.crossOrigin="",m.href=c,n&&m.setAttribute("nonce",n),document.head.appendChild(m),p)return new Promise((h,v)=>{m.addEventListener("load",h),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return s.then(i=>{for(const d of i||[])d.status==="rejected"&&o(d.reason);return t().catch(o)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const A="modulepreload",I=function(a,t){return new URL(a,t).href},f={},T=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=I(n,r),n in f)return;f[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":A,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const P="modulepreload",B=function(a,t){return new URL(a,t).href},x={},q=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=B(n,r),n in x)return;x[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":P,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const j="modulepreload",z=function(a,t){return new URL(a,t).href},b={},O=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=z(n,r),n in b)return;b[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":j,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const D="modulepreload",H=function(a,t){return new URL(a,t).href},y={},$=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=H(n,r),n in y)return;y[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":D,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const N="modulepreload",R=function(a,t){return new URL(a,t).href},w={},U=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=R(n,r),n in w)return;w[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":N,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const V="modulepreload",G=function(a,t){return new URL(a,t).href},k={},_=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=G(n,r),n in k)return;k[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":V,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const K="modulepreload",W=function(a,t){return new URL(a,t).href},E={},F=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=W(n,r),n in E)return;E[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":K,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const Q="modulepreload",Y=function(a,t){return new URL(a,t).href},C={},J=function(a,t,r){let e=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));e=Promise.allSettled(t.map(n=>{if(n=Y(n,r),n in C)return;C[n]=!0;const c=n.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(r)for(let u=o.length-1;u>=0;u--){const m=o[u];if(m.href===n&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":Q,c||(l.as="script"),l.crossOrigin="",l.href=n,d&&l.setAttribute("nonce",d),document.head.appendChild(l),c)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${n}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return e.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return a().catch(s)})};class X extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const t=this.querySelector("#mobileMenuBtn"),r=this.querySelector("#mobileMenu");t&&r&&t.addEventListener("click",()=>{r.classList.toggle("hidden")}),document.addEventListener("click",e=>{r&&!this.contains(e.target)&&!r.classList.contains("hidden")&&r.classList.add("hidden")})}}customElements.define("header-component",X);class Z extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const t=this.querySelector("#heroCtaBtn"),r=this.querySelector("#learnMoreBtn");t&&t.addEventListener("click",()=>{const e=encodeURIComponent("Hola! Quiero comenzar con sus servicios de IA y automatización. ¿Podemos hablar sobre cómo transformar mi negocio?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}),r&&r.addEventListener("click",()=>{document.querySelector("#services").scrollIntoView({behavior:"smooth"})})}setupIntersectionObserver(){const t=new IntersectionObserver(r=>{r.forEach(e=>{e.isIntersecting&&e.target.classList.add("animate-slide-up")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(r=>t.observe(r))},100)}}customElements.define("hero-section",Z);class ee extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const t=this.querySelector("#servicesCtaBtn"),r=this.querySelectorAll(".group");t&&t.addEventListener("click",()=>{const e=encodeURIComponent("Hola! Me gustaría solicitar una demo gratuita de sus servicios de IA y automatización. ¿Podemos agendar una reunión?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}),r.forEach((e,s)=>{e.addEventListener("click",()=>{this.showServiceDetails(s)})})}setupIntersectionObserver(){const t=new IntersectionObserver(r=>{r.forEach(e=>{e.isIntersecting&&(e.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(r=>t.observe(r))},100)}showServiceDetails(t){const r=[{name:"E-commerce",message:"Hola! Me interesa su servicio de E-commerce. Me gustaría conocer más sobre las tiendas online con integración de pagos."},{name:"IT Solutions",message:"Hola! Necesito soluciones IT para mi empresa. ¿Podemos hablar sobre infraestructura tecnológica?"},{name:"IA Solutions",message:"Hola! Me gustaría conocer sus soluciones de IA y automatización inteligente."},{name:"Desarrollo Web",message:"Hola! Estoy interesado en desarrollo web moderno. ¿Podemos discutir mi proyecto?"},{name:"Marketing Digital",message:"Hola! Quiero mejorar mi presencia digital. ¿Cómo pueden ayudarme con marketing online?"},{name:"SEO Optimization",message:"Hola! Necesito mejorar mi posicionamiento web. ¿Ofrecen servicios de SEO?"},{name:"Coaching Empresarial",message:"Hola! Busco coaching empresarial para hacer crecer mi negocio."},{name:"Consultoría Técnica",message:"Hola! Necesito consultoría especializada en tecnología y transformación digital."}][t],e=encodeURIComponent(r.message);window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}}customElements.define("services-section",ee);class te extends HTMLElement{constructor(){super(),this.metrics={activeUsers:0,campaigns:0,conversions:0,revenue:0},this.interval=null}connectedCallback(){this.render(),this.startLiveUpdates(),this.setupIntersectionObserver()}disconnectedCallback(){this.interval&&clearInterval(this.interval)}render(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const t=this.querySelector("#dashboardCtaBtn");t&&t.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const t=(i,d)=>Math.floor(Math.random()*(d-i+1))+i,r=this.querySelector("#activeUsers"),e=this.querySelector("#activeCampaigns"),s=this.querySelector("#conversions"),o=this.querySelector("#revenue");if(r){const i=(parseInt(r.textContent.replace(",",""))||2847)+t(-2,5);r.textContent=i.toLocaleString()}if(e){const i=(parseInt(e.textContent)||47)+t(-1,1);e.textContent=Math.max(45,i)}if(s){const i=(parseInt(s.textContent.replace(",",""))||1284)+t(1,8);s.textContent=i.toLocaleString()}if(o){const i=parseFloat(o.textContent.replace("$","").replace("K",""))||24.7,d=t(1,3)/10,n=i+d;o.textContent=`$${n.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((t,r)=>{setTimeout(()=>{t.style.transition="height 1s ease-in-out"},r*100)})},500)}setupIntersectionObserver(){const t=new IntersectionObserver(r=>{r.forEach(e=>{e.isIntersecting&&(e.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(r=>t.observe(r))},100)}}customElements.define("dashboard-section",te);class se extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const t=this.querySelector("#prevTestimonial"),r=this.querySelector("#nextTestimonial"),e=this.querySelectorAll(".testimonial-dot"),s=this.querySelector("#premiumCtaBtn"),o=this.querySelector("#essentialCtaBtn");t&&t.addEventListener("click",()=>this.previousTestimonial()),r&&r.addEventListener("click",()=>this.nextTestimonial()),e.forEach(i=>{i.addEventListener("click",d=>{const n=parseInt(d.target.dataset.index);this.goToTestimonial(n)})}),s&&s.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")}),o&&o.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(t){t>=0&&t<3&&(this.currentTestimonial=t,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const t=this.querySelector("#testimonialContent"),r=this.querySelectorAll(".testimonial-dot");if(t){const e=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];t.innerHTML=`
                <div class="text-center">
                    <div class="text-6xl mb-4">"</div>
                    <p class="text-xl text-gray-700 mb-6 italic">
                        ${e.text}
            ...
            `}r.forEach((e,s)=>{s===this.currentTestimonial?(e.classList.remove("bg-gray-300"),e.classList.add("bg-primary-blue")):(e.classList.remove("bg-primary-blue"),e.classList.add("bg-gray-300"))})}}customElements.define("club-section",se);class re extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
...
Piensa primero, luego genera la descripción optimizada para Instagram.`},{role:"user",content:`Investiga y genera una descripción optimizada para Instagram del producto: ${t}. Incluye información real sobre qué es este producto, su contexto y características principales.`}],max_tokens:600,temperature:.8})});if(!r.ok)throw new Error(`API request failed: ${r.status}`);const e=(await r.json()).choices[0].message.content.trim();let s="",o="",i="";const d=e.match(/Título:\s*(.+?)(?:\n|$)/i);d&&(s=d[1].trim());const n=e.match(/Descripción:\s*(.+?)(?:\nHashtags:|$)/is);n&&(o=n[1].trim());const c=e.match(/Hashtags:\s*(.+?)(?:\n|$)/is);return c&&(i=c[1].trim()),(!s||!o)&&(o=e,s=`${t} – Descubre la Diferencia`,i="#Innovacion2025 #ProductoPremium #CalidadSuperior"),`---
Título: ${s}
Descripción: ${o}
Hashtags: ${i}
---`}catch(r){console.error("Error calling DeepSeek API:",r);const e=[{title:`${t} – Innovación que Transforma`,description:`Descubre el poder de ${t}. Una solución revolucionaria que combina tecnología avanzada con diseño intuitivo. Ideal para quienes buscan calidad superior y resultados excepcionales. ¿Listo para experimentar la diferencia?`,hashtags:["#Innovacion2025","#TecnologiaAvanzada","#SolucionesInteligentes","#CalidadSuperior","#TransformacionDigital","#ProductoRevolucionario"]},{title:`${t} – Elegancia que Inspira`,description:`Experimenta la perfección con ${t}. Diseñado para elevar tus estándares y superar expectativas. Cada detalle pensado para ofrecer una experiencia incomparable. ¿Qué esperas para vivir la excelencia?`,hashtags:["#Elegancia2025","#DisenoPremium","#ExperienciaIncomparable","#CalidadInigualable","#EstiloModerno","#PerfeccionAbsoluta"]},{title:`${t} – Potencia y Rendimiento`,description:`Libera todo el potencial con ${t}. Tecnología de vanguardia que garantiza rendimiento óptimo y durabilidad excepcional. Para quienes exigen lo mejor y no se conforman con menos. ¡Hazlo tuyo ahora!`,hashtags:["#Potencia2025","#RendimientoMaximo","#TecnologiaVanguardia","#DurabilidadSuperior","#CalidadGarantizada","#PerformanceElite"]}],s=e[Math.floor(Math.random()*e.length)];return`---
Título: ${s.title}
Descripción: ${s.description}
Hashtags: ${s.hashtags.join(" ")}
---`}}showLoading(t){const r=this.querySelector("#loadingState"),e=this.querySelector("#generateBtn");t?(r.classList.remove("hidden"),e.disabled=!0,e.textContent="Generando..."):(r.classList.add("hidden"),e.disabled=!1,e.textContent="Generar Descripción ✨")}showResult(t){const r=this.querySelector("#resultSection"),e=this.querySelector("#generatedContent pre");e.textContent=t,r.classList.remove("hidden"),r.scrollIntoView({behavior:"smooth",block:"nearest"})}async copyToClipboard(){try{await navigator.clipboard.writeText(this.generatedDescription),this.showCopySuccess()}catch(t){console.error("Error copying to clipboard:",t);const r=document.createElement("textarea");r.value=this.generatedDescription,document.body.appendChild(r),r.select(),document.execCommand("copy"),document.body.removeChild(r),this.showCopySuccess()}}showCopySuccess(){const t=this.querySelector("#copySuccess");t.classList.remove("hidden"),setTimeout(()=>{t.classList.add("hidden")},3e3)}showNotification(t,r="info"){const e=document.createElement("div"),s={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};e.className=`fixed top-4 right-4 ${s[r]} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 translate-x-0`,e.textContent=t,document.body.appendChild(e),setTimeout(()=>{e.style.transform="translateX(100%)",setTimeout(()=>e.remove(),300)},3e3)}}customElements.define("instagram-description-component",re);class oe extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupAnimations()}render(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const t=this.querySelector(".cta-primary");t&&t.addEventListener("click",()=>{this.handlePrimaryCTA()});const r=this.querySelector(".cta-secondary");r&&r.addEventListener("click",()=>{this.handleSecondaryCTA()})}setupAnimations(){this.querySelectorAll(".animate-slide-up").forEach((t,r)=>{t.style.animationDelay=`${r*200}ms`}),this.animateFloatingElements()}animateFloatingElements(){this.querySelectorAll(".floating-element-1, .floating-element-2, .floating-element-3").forEach((t,r)=>{if(t.style.animation=`float 6s ease-in-out infinite ${r*2}s`,!document.querySelector("#floatingKeyframes")){const e=document.createElement("style");e.id="floatingKeyframes",e.textContent=`
                    @keyframes float {
                        0%, 100% { transform: translateY(0px) rotate(0deg); }
                        50% { transform: translateY(-20px) rotate(180deg); }
                    }
                `,document.head.appendChild(e)}})}handlePrimaryCTA(){const t=encodeURIComponent("Hola! Quiero comenzar con sus servicios de IA y automatización. ¿Podemos hablar sobre cómo transformar mi negocio?");window.open(`https://wa.me/542923560623?text=${t}`,"_blank")}handleSecondaryCTA(){const t=encodeURIComponent("Hola! Me gustaría agendar una demo gratuita para conocer sus soluciones de IA. ¿Cuándo podríamos tener una reunión?");window.open(`https://wa.me/542923560623?text=${t}`,"_blank")}updateCTAContent(t){if(t.title){const r=this.querySelector("h2");r&&(r.textContent=t.title)}if(t.subtitle){const r=this.querySelector("p.text-gray-300");r&&(r.textContent=t.subtitle)}if(t.primaryButton){const r=this.querySelector(".cta-primary span");r&&(r.textContent=t.primaryButton)}if(t.secondaryButton){const r=this.querySelector(".cta-secondary");r&&(r.textContent=t.secondaryButton)}}}customElements.define("cta-section",oe);class ie extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){this.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",r=>{r.preventDefault();const e=t.getAttribute("href").substring(1),s=document.getElementById(e);s&&s.scrollIntoView({behavior:"smooth",block:"start"})})}),this.querySelectorAll("[data-service]").forEach(t=>{t.addEventListener("click",r=>{r.preventDefault();const e=t.getAttribute("data-service");let s="";switch(e){case"ia":s="Hola! Me interesa su Asistente IA. ¿Podemos hablar sobre cómo implementar inteligencia artificial en mi negocio?";break;case"bots":s="Hola! Quiero conocer más sobre sus Bots Omnicanal. ¿Cómo pueden ayudarme con la automatización de atención al cliente?";break;case"campanas":s="Hola! Me gustaría saber más sobre sus Campañas Garantizadas. ¿Cómo funcionan y cuáles son los resultados esperados?";break;case"growth":s="Hola! El Growth Simulator me parece muy interesante. ¿Podemos discutir cómo simular el crecimiento de mi negocio?";break;default:s="Hola! Me gustaría obtener más información sobre sus servicios."}const o=encodeURIComponent(s);window.open(`https://wa.me/542923560623?text=${o}`,"_blank")})})}}customElements.define("footer-component",ie);class ne extends HTMLElement{constructor(){super(),this.isOpen=!1,this.conversation=[],this.isTyping=!1}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
    ...
    `}setupEventListeners(){const t=this.querySelector("#chatToggle"),r=this.querySelector("#chatWindow"),e=this.querySelector("#closeChat"),s=this.querySelector("#sendMessage"),o=this.querySelector("#messageInput");t.addEventListener("click",()=>{this.isOpen=!this.isOpen,r.classList.toggle("hidden",!this.isOpen),this.isOpen&&o.focus()}),e.addEventListener("click",()=>{this.isOpen=!1,r.classList.add("hidden")});const i=()=>{const d=o.value.trim();d&&!this.isTyping&&(this.addUserMessage(d),o.value="",this.getAIResponse(d))};s.addEventListener("click",i),o.addEventListener("keypress",d=>{d.key==="Enter"&&i()}),o.addEventListener("input",()=>{s.disabled=!o.value.trim()||this.isTyping})}addUserMessage(t){const r=this.querySelector("#messagesContainer"),e=document.createElement("div");e.className="message user-message bg-primary-blue text-white rounded-lg p-3 shadow-sm mb-3 ml-8",e.innerHTML=`<p class="text-sm">${this.escapeHtml(t)}</p>`,r.appendChild(e),this.scrollToBottom()}addBotMessage(t){const r=this.querySelector("#messagesContainer"),e=document.createElement("div");e.className="message bot-message bg-white rounded-lg p-3 shadow-sm mb-3",e.innerHTML=`<p class="text-sm text-gray-700">${this.formatMessage(t)}</p>`,r.appendChild(e),this.scrollToBottom()}async getAIResponse(t){this.showTypingIndicator(),this.isTyping=!0;try{const r=await this.callDeepSeekAPI(t);this.hideTypingIndicator(),this.addBotMessage(r)}catch(r){console.error("Error calling DeepSeek API:",r),this.hideTypingIndicator(),this.addBotMessage("Lo siento, estoy teniendo problemas para conectarme. Por favor, intenta nuevamente en un momento.")}this.isTyping=!1,this.updateSendButtonState()}getApiKey(){return console.error("VITE_CHATBOT_API_KEY not found in environment variables"),null}async callDeepSeekAPI(t){const r=this.getApiKey(),e="https://api.deepseek.com/v1/chat/completions",s=`Eres el asistente oficial de Boom Digital Agency. Responde en español de manera profesional y amigable. 
...
Responde como representante oficial de Boom Digital Agency, manteniendo un tono profesional pero cercano.`,o=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Eres un asistente profesional de Boom Digital Agency, especializado en soluciones de IA y transformación digital. Responde siempre en español de manera clara y útil."},{role:"user",content:s}],max_tokens:500,temperature:.7})});if(!o.ok)throw new Error(`API error: ${o.status}`);return(await o.json()).choices[0].message.content}showTypingIndicator(){this.querySelector("#typingIndicator").classList.remove("hidden"),this.scrollToBottom()}hideTypingIndicator(){this.querySelector("#typingIndicator").classList.add("hidden")}scrollToBottom(){const t=this.querySelector("#messagesContainer");t.scrollTop=t.scrollHeight}updateSendButtonState(){const t=this.querySelector("#sendMessage"),r=this.querySelector("#messageInput");t.disabled=!r.value.trim()||this.isTyping}escapeHtml(t){const r=document.createElement("div");return r.textContent=t,r.innerHTML}formatMessage(t){return t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="text-primary-blue underline">$1</a>')}}customElements.define("chat-bot",ne);class ae{constructor(){this.init()}init(){console.log("Boom Digital Agency - Application Started"),this.setupScrollAnimations(),this.setupLazyLoading(),this.trackPageView()}setupScrollAnimations(){const t={threshold:.1,rootMargin:"0px 0px -50px 0px"},r=new IntersectionObserver(e=>{e.forEach(s=>{s.isIntersecting&&s.target.classList.add("animate-fade-in","animate-slide-up")})},t);document.querySelectorAll("section, .animate-on-scroll").forEach(e=>{r.observe(e)})}setupLazyLoading(){const t=new IntersectionObserver((r,e)=>{r.forEach(s=>{if(s.isIntersecting){const o=s.target;o.src=o.dataset.src,o.classList.remove("lazy"),e.unobserve(o)}})});document.querySelectorAll("img[data-src]").forEach(r=>{t.observe(r)})}async trackPageView(){try{const{trackPageView:t}=await J(async()=>{const{trackPageView:r}=await F(()=>_(()=>U(()=>$(()=>O(()=>q(()=>T(()=>M(()=>import("./firebase-6dUurx0Q-BXuLB0tj-CkyGTK-u-_ub-MjIu-Dsa3sb0U-BITRcsr3-ahVpZ8vh-_ub-MjIu-Dsa3sb0U.js"),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url),[],import.meta.url);return{trackPageView:r}},[],import.meta.url);await t("home")}catch{console.log("Analytics tracking not available in development")}}}document.addEventListener("DOMContentLoaded",()=>{new ae});
