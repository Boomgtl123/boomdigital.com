(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const w="modulepreload",k=function(n,e){return new URL(n,e).href},b={},C=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){const i=document.getElementsByTagName("link"),o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));a=Promise.allSettled(t.map(c=>{if(c=k(c,s),c in b)return;b[c]=!0;const p=c.endsWith(".css"),d=p?'[rel="stylesheet"]':"";if(!!s)for(let h=i.length-1;h>=0;h--){const v=i[h];if(v.href===c&&(!p||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${d}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":w,p||(m.as="script"),m.crossOrigin="",m.href=c,l&&m.setAttribute("nonce",l),document.head.appendChild(m),p)return new Promise((h,v)=>{m.addEventListener("load",h),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return a.then(i=>{for(const o of i||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();const E="modulepreload",S=function(n,e){return new URL(n,e).href},f={},M=function(n,e,t){let s=Promise.resolve();if(e&&e.length>0){const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(e.map(l=>{if(l=S(l,t),l in f)return;f[l]=!0;const c=l.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(t)for(let u=r.length-1;u>=0;u--){const m=r[u];if(m.href===l&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${p}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":E,c||(d.as="script"),d.crossOrigin="",d.href=l,o&&d.setAttribute("nonce",o),document.head.appendChild(d),c)return new Promise((u,m)=>{d.addEventListener("load",u),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return s.then(r=>{for(const i of r||[])i.status==="rejected"&&a(i.reason);return n().catch(a)})};(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();const L="modulepreload",I=function(n,e){return new URL(n,e).href},y={},T=function(n,e,t){let s=Promise.resolve();if(e&&e.length>0){const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(e.map(l=>{if(l=I(l,t),l in y)return;y[l]=!0;const c=l.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(t)for(let u=r.length-1;u>=0;u--){const m=r[u];if(m.href===l&&(!c||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${p}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":L,c||(d.as="script"),d.crossOrigin="",d.href=l,o&&d.setAttribute("nonce",o),document.head.appendChild(d),c)return new Promise((u,m)=>{d.addEventListener("load",u),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return s.then(r=>{for(const i of r||[])i.status==="rejected"&&a(i.reason);return n().catch(a)})};class A extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#mobileMenuBtn"),t=this.querySelector("#mobileMenu");e&&t&&e.addEventListener("click",()=>{t.classList.toggle("hidden")}),document.addEventListener("click",s=>{t&&!this.contains(s.target)&&!t.classList.contains("hidden")&&t.classList.add("hidden")})}}customElements.define("header-component",A);class B extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const e=this.querySelector("#heroCtaBtn"),t=this.querySelector("#learnMoreBtn");e&&e.addEventListener("click",()=>{const s=encodeURIComponent("Hola! Quiero comenzar con sus servicios de IA y automatización. ¿Podemos hablar sobre cómo transformar mi negocio?");window.open(`https://wa.me/542923560623?text=${s}`,"_blank")}),t&&t.addEventListener("click",()=>{document.querySelector("#services").scrollIntoView({behavior:"smooth"})})}setupIntersectionObserver(){const e=new IntersectionObserver(t=>{t.forEach(s=>{s.isIntersecting&&s.target.classList.add("animate-slide-up")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(t=>e.observe(t))},100)}}customElements.define("hero-section",B);class z extends HTMLElement{constructor(){super(),this.websiteContent=null}connectedCallback(){this.loadContent(),this.setupIntersectionObserver()}async loadContent(){this.renderWithDefaultContent()}renderWithDefaultContent(){this.innerHTML=`
        ...
        `,this.setupEventListeners(),this.animateChart()}setupEventListeners(){const e=this.querySelector("#dashboardCtaBtn");e&&e.addEventListener("click",()=>{document.querySelector("#contact").scrollIntoView({behavior:"smooth"})})}startLiveUpdates(){this.interval=setInterval(()=>{this.updateMetrics()},3e3),this.updateMetrics()}updateMetrics(){const e=(i,o)=>Math.floor(Math.random()*(o-i+1))+i,t=this.querySelector("#activeUsers"),s=this.querySelector("#activeCampaigns"),a=this.querySelector("#conversions"),r=this.querySelector("#revenue");if(t){const i=(parseInt(t.textContent.replace(",",""))||2847)+e(-2,5);t.textContent=i.toLocaleString()}if(s){const i=(parseInt(s.textContent)||47)+e(-1,1);s.textContent=Math.max(45,i)}if(a){const i=(parseInt(a.textContent.replace(",",""))||1284)+e(1,8);a.textContent=i.toLocaleString()}if(r){const i=parseFloat(r.textContent.replace("$","").replace("K",""))||24.7,o=e(1,3)/10,l=i+o;r.textContent=`$${l.toFixed(1)}K`}}animateChart(){setTimeout(()=>{this.querySelectorAll(".bg-primary-blue").forEach((e,t)=>{setTimeout(()=>{e.style.transition="height 1s ease-in-out"},t*100)})},500)}setupIntersectionObserver(){const e=new IntersectionObserver(t=>{t.forEach(s=>{s.isIntersecting&&(s.target.style.animationPlayState="running")})},{threshold:.1});setTimeout(()=>{this.querySelectorAll(".animate-fade-in, .animate-slide-up").forEach(t=>e.observe(t))},100)}}customElements.define("dashboard-section",P);class j extends HTMLElement{constructor(){super(),this.currentTestimonial=0}connectedCallback(){this.render(),this.setupEventListeners(),this.startTestimonialRotation()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#prevTestimonial"),t=this.querySelector("#nextTestimonial"),s=this.querySelectorAll(".testimonial-dot"),a=this.querySelector("#premiumCtaBtn"),r=this.querySelector("#essentialCtaBtn");e&&e.addEventListener("click",()=>this.previousTestimonial()),t&&t.addEventListener("click",()=>this.nextTestimonial()),s.forEach(i=>{i.addEventListener("click",o=>{const l=parseInt(o.target.dataset.index);this.goToTestimonial(l)})}),a&&a.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa unirme al Club Premium de Boom Digital. ¿Podemos hablar sobre los beneficios y cómo comenzar?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")}),r&&r.addEventListener("click",()=>{const i=encodeURIComponent("Hola! Me interesa comenzar con el Club Essential de Boom Digital. ¿Podemos hablar sobre las opciones disponibles?");window.open(`https://wa.me/542923560623?text=${i}`,"_blank")})}startTestimonialRotation(){setInterval(()=>{this.nextTestimonial()},5e3)}nextTestimonial(){this.currentTestimonial=(this.currentTestimonial+1)%3,this.updateTestimonialDisplay()}previousTestimonial(){this.currentTestimonial=(this.currentTestimonial-1+3)%3,this.updateTestimonialDisplay()}goToTestimonial(e){e>=0&&e<3&&(this.currentTestimonial=e,this.updateTestimonialDisplay())}updateTestimonialDisplay(){const e=this.querySelector("#testimonialContent"),t=this.querySelectorAll(".testimonial-dot");if(e){const s=[{text:"Boom Digital revolucionó nuestro enfoque digital. La implementación de IA nos permitió escalar operaciones y mejorar significativamente nuestro ROI.",name:"Carlos Rodríguez",company:"CEO, TechStart Inc"},{text:"La automatización con IA nos ahorró 20 horas semanales en tareas repetitivas. El equipo de Boom Digital es excepcional.",name:"María González",company:"Ecommerce Pro"},{text:"Desde que implementamos las soluciones de Boom Digital, nuestro engagement ha aumentado un 300%. Recomendado 100%.",name:"Ana Martínez",company:"Growth Labs"}][this.currentTestimonial];e.innerHTML=`
                <div class="text-center">
                    <div class="text-6xl mb-4">"</div>
                    <p class="text-xl text-gray-700 mb-6 italic">
                        ${s.text}
            ...
            `}t.forEach((s,a)=>{a===this.currentTestimonial?(s.classList.remove("bg-gray-300"),s.classList.add("bg-primary-blue")):(s.classList.remove("bg-primary-blue"),s.classList.add("bg-gray-300"))})}}customElements.define("club-section",j);var g={};class q extends HTMLElement{constructor(){super(),this.productName="",this.generatedDescription=""}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){const e=this.querySelector("#generateBtn"),t=this.querySelector("#copyBtn"),s=this.querySelector("#productName");e.addEventListener("click",()=>this.generateDescription()),t.addEventListener("click",()=>this.copyToClipboard()),s.addEventListener("keypress",a=>{a.key==="Enter"&&this.generateDescription()})}async generateDescription(){const e=this.querySelector("#productName").value.trim();if(!e){this.showNotification("Por favor ingresa el nombre del producto","error");return}this.showLoading(!0);try{const t=await this.generateAIDescription(e);this.generatedDescription=t,this.showResult(t),this.showLoading(!1)}catch(t){console.error("Error generating description:",t),this.showNotification("Error al generar la descripción. Inténtalo de nuevo.","error"),this.showLoading(!1)}}getApiKey(){return typeof process<"u"&&g&&g.DEEPSEEK_API_KEY?g.DEEPSEEK_API_KEY:"sk-0617e0618310453f92852ecfd933143c"}async generateAIDescription(e){try{const t=await fetch("https://api.deepseek.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.getApiKey()}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:`Eres un experto en marketing digital y copywriting para redes sociales con acceso a conocimiento actualizado. Tu tarea es investigar el producto, pensar paso a paso sobre su valor y características, y luego generar una descripción de Instagram optimizada con información real y factual.
...
Piensa primero, luego genera la descripción optimizada para Instagram.`},{role:"user",content:`Investiga y genera una descripción optimizada para Instagram del producto: ${e}. Incluye información real sobre qué es este producto, su contexto y características principales.`}],max_tokens:600,temperature:.8})});if(!t.ok)throw new Error(`API request failed: ${t.status}`);const s=(await t.json()).choices[0].message.content.trim();let a="",r="",i="";const o=s.match(/Título:\s*(.+?)(?:\n|$)/i);o&&(a=o[1].trim());const l=s.match(/Descripción:\s*(.+?)(?:\nHashtags:|$)/is);l&&(r=l[1].trim());const c=s.match(/Hashtags:\s*(.+?)(?:\n|$)/is);return c&&(i=c[1].trim()),(!a||!r)&&(r=s,a=`${e} – Descubre la Diferencia`,i="#Innovacion2025 #ProductoPremium #CalidadSuperior"),`---
Título: ${a}
Descripción: ${r}
Hashtags: ${i}
---`}catch(t){console.error("Error calling DeepSeek API:",t);const s=[{title:`${e} – Innovación que Transforma`,description:`Descubre el poder de ${e}. Una solución revolucionaria que combina tecnología avanzada con diseño intuitivo. Ideal para quienes buscan calidad superior y resultados excepcionales. ¿Listo para experimentar la diferencia?`,hashtags:["#Innovacion2025","#TecnologiaAvanzada","#SolucionesInteligentes","#CalidadSuperior","#TransformacionDigital","#ProductoRevolucionario"]},{title:`${e} – Elegancia que Inspira`,description:`Experimenta la perfección con ${e}. Diseñado para elevar tus estándares y superar expectativas. Cada detalle pensado para ofrecer una experiencia incomparable. ¿Qué esperas para vivir la excelencia?`,hashtags:["#Elegancia2025","#DisenoPremium","#ExperienciaIncomparable","#CalidadInigualable","#EstiloModerno","#PerfeccionAbsoluta"]},{title:`${e} – Potencia y Rendimiento`,description:`Libera todo el potencial con ${e}. Tecnología de vanguardia que garantiza rendimiento óptimo y durabilidad excepcional. Para quienes exigen lo mejor y no se conforman con menos. ¡Hazlo tuyo ahora!`,hashtags:["#Potencia2025","#RendimientoMaximo","#TecnologiaVanguardia","#DurabilidadSuperior","#CalidadGarantizada","#PerformanceElite"]}],a=s[Math.floor(Math.random()*s.length)];return`---
Título: ${a.title}
Descripción: ${a.description}
Hashtags: ${a.hashtags.join(" ")}
---`}}showLoading(e){const t=this.querySelector("#loadingState"),s=this.querySelector("#generateBtn");e?(t.classList.remove("hidden"),s.disabled=!0,s.textContent="Generando..."):(t.classList.add("hidden"),s.disabled=!1,s.textContent="Generar Descripción ✨")}showResult(e){const t=this.querySelector("#resultSection"),s=this.querySelector("#generatedContent pre");s.textContent=e,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}async copyToClipboard(){try{await navigator.clipboard.writeText(this.generatedDescription),this.showCopySuccess()}catch(e){console.error("Error copying to clipboard:",e);const t=document.createElement("textarea");t.value=this.generatedDescription,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),this.showCopySuccess()}}showCopySuccess(){const e=this.querySelector("#copySuccess");e.classList.remove("hidden"),setTimeout(()=>{e.classList.add("hidden")},3e3)}showNotification(e,t="info"){const s=document.createElement("div"),a={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`fixed top-4 right-4 ${a[t]} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 translate-x-0`,s.textContent=e,document.body.appendChild(s),setTimeout(()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),300)},3e3)}}customElements.define("instagram-description-component",q);class D extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupAnimations()}render(){this.innerHTML=`
        ...
        `,this.setupEventListeners()}setupEventListeners(){const e=this.querySelector(".cta-primary");e&&e.addEventListener("click",()=>{this.handlePrimaryCTA()});const t=this.querySelector(".cta-secondary");t&&t.addEventListener("click",()=>{this.handleSecondaryCTA()})}setupAnimations(){this.querySelectorAll(".animate-slide-up").forEach((e,t)=>{e.style.animationDelay=`${t*200}ms`}),this.animateFloatingElements()}animateFloatingElements(){this.querySelectorAll(".floating-element-1, .floating-element-2, .floating-element-3").forEach((e,t)=>{if(e.style.animation=`float 6s ease-in-out infinite ${t*2}s`,!document.querySelector("#floatingKeyframes")){const s=document.createElement("style");s.id="floatingKeyframes",s.textContent=`
                    @keyframes float {
                        0%, 100% { transform: translateY(0px) rotate(0deg); }
                        50% { transform: translateY(-20px) rotate(180deg); }
                    }
                `,document.head.appendChild(s)}})}handlePrimaryCTA(){const e=encodeURIComponent("Hola! Quiero comenzar con sus servicios de IA y automatización. ¿Podemos hablar sobre cómo transformar mi negocio?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}handleSecondaryCTA(){const e=encodeURIComponent("Hola! Me gustaría agendar una demo gratuita para conocer sus soluciones de IA. ¿Cuándo podríamos tener una reunión?");window.open(`https://wa.me/542923560623?text=${e}`,"_blank")}updateCTAContent(e){if(e.title){const t=this.querySelector("h2");t&&(t.textContent=e.title)}if(e.subtitle){const t=this.querySelector("p.text-gray-300");t&&(t.textContent=e.subtitle)}if(e.primaryButton){const t=this.querySelector(".cta-primary span");t&&(t.textContent=e.primaryButton)}if(e.secondaryButton){const t=this.querySelector(".cta-secondary");t&&(t.textContent=e.secondaryButton)}}}customElements.define("cta-section",D);class H extends HTMLElement{constructor(){super()}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
        ...
        `}setupEventListeners(){this.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const s=e.getAttribute("href").substring(1),a=document.getElementById(s);a&&a.scrollIntoView({behavior:"smooth",block:"start"})})}),this.querySelectorAll("[data-service]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const s=e.getAttribute("data-service");let a="";switch(s){case"ia":a="Hola! Me interesa su Asistente IA. ¿Podemos hablar sobre cómo implementar inteligencia artificial en mi negocio?";break;case"bots":a="Hola! Quiero conocer más sobre sus Bots Omnicanal. ¿Cómo pueden ayudarme con la automatización de atención al cliente?";break;case"campanas":a="Hola! Me gustaría saber más sobre sus Campañas Garantizadas. ¿Cómo funcionan y cuáles son los resultados esperados?";break;case"growth":a="Hola! El Growth Simulator me parece muy interesante. ¿Podemos discutir cómo simular el crecimiento de mi negocio?";break;default:a="Hola! Me gustaría obtener más información sobre sus servicios."}const r=encodeURIComponent(a);window.open(`https://wa.me/542923560623?text=${r}`,"_blank")})})}}customElements.define("footer-component",H);var x={};class O extends HTMLElement{constructor(){super(),this.isOpen=!1,this.conversation=[],this.isTyping=!1}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
    ...
    `}setupEventListeners(){const e=this.querySelector("#chatToggle"),t=this.querySelector("#chatWindow"),s=this.querySelector("#closeChat"),a=this.querySelector("#sendMessage"),r=this.querySelector("#messageInput");e.addEventListener("click",()=>{this.isOpen=!this.isOpen,t.classList.toggle("hidden",!this.isOpen),this.isOpen&&r.focus()}),s.addEventListener("click",()=>{this.isOpen=!1,t.classList.add("hidden")});const i=()=>{const o=r.value.trim();o&&!this.isTyping&&(this.addUserMessage(o),r.value="",this.getAIResponse(o))};a.addEventListener("click",i),r.addEventListener("keypress",o=>{o.key==="Enter"&&i()}),r.addEventListener("input",()=>{a.disabled=!r.value.trim()||this.isTyping})}addUserMessage(e){const t=this.querySelector("#messagesContainer"),s=document.createElement("div");s.className="message user-message bg-primary-blue text-white rounded-lg p-3 shadow-sm mb-3 ml-8",s.innerHTML=`<p class="text-sm">${this.escapeHtml(e)}</p>`,t.appendChild(s),this.scrollToBottom()}addBotMessage(e){const t=this.querySelector("#messagesContainer"),s=document.createElement("div");s.className="message bot-message bg-white rounded-lg p-3 shadow-sm mb-3",s.innerHTML=`<p class="text-sm text-gray-700">${this.formatMessage(e)}</p>`,t.appendChild(s),this.scrollToBottom()}async getAIResponse(e){this.showTypingIndicator(),this.isTyping=!0;try{const t=await this.callDeepSeekAPI(e);this.hideTypingIndicator(),this.addBotMessage(t)}catch(t){console.error("Error calling DeepSeek API:",t),this.hideTypingIndicator(),this.addBotMessage("Lo siento, estoy teniendo problemas para conectarme. Por favor, intenta nuevamente en un momento.")}this.isTyping=!1,this.updateSendButtonState()}getApiKey(){return typeof process<"u"&&x&&x.CHATBOT_API_KEY?x.CHATBOT_API_KEY:"sk-59b0807d89344fb781f3d9b1baf35753"}async callDeepSeekAPI(e){const t=this.getApiKey(),s="https://api.deepseek.com/v1/chat/completions",a=`Eres el asistente oficial de Boom Digital Agency. Responde en español de manera profesional y amigable. 
...
Responde como representante oficial de Boom Digital Agency, manteniendo un tono profesional pero cercano.`,r=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({model:"deepseek-chat",messages:[{role:"system",content:"Eres un asistente profesional de Boom Digital Agency, especializado en soluciones de IA y transformación digital. Responde siempre en español de manera clara y útil."},{role:"user",content:a}],max_tokens:500,temperature:.7})});if(!r.ok)throw new Error(`API error: ${r.status}`);return(await r.json()).choices[0].message.content}showTypingIndicator(){this.querySelector("#typingIndicator").classList.remove("hidden"),this.scrollToBottom()}hideTypingIndicator(){this.querySelector("#typingIndicator").classList.add("hidden")}scrollToBottom(){const e=this.querySelector("#messagesContainer");e.scrollTop=e.scrollHeight}updateSendButtonState(){const e=this.querySelector("#sendMessage"),t=this.querySelector("#messageInput");e.disabled=!t.value.trim()||this.isTyping}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}formatMessage(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="text-primary-blue underline">$1</a>')}}customElements.define("chat-bot",O);class ${constructor(){this.init()}init(){console.log("Boom Digital Agency - Application Started"),this.setupScrollAnimations(),this.setupLazyLoading(),this.trackPageView()}setupScrollAnimations(){const e={threshold:.1,rootMargin:"0px 0px -50px 0px"},t=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&a.target.classList.add("animate-fade-in","animate-slide-up")})},e);document.querySelectorAll("section, .animate-on-scroll").forEach(s=>{t.observe(s)})}setupLazyLoading(){const e=new IntersectionObserver((t,s)=>{t.forEach(a=>{if(a.isIntersecting){const r=a.target;r.src=r.dataset.src,r.classList.remove("lazy"),s.unobserve(r)}})});document.querySelectorAll("img[data-src]").forEach(t=>{e.observe(t)})}async trackPageView(){try{const{trackPageView:e}=await T(async()=>{const{trackPageView:t}=await M(()=>C(()=>import("./firebase-Bw_4rmA1-C7_HaL2c-CFF20m2R.js"),[],import.meta.url),[],import.meta.url);return{trackPageView:t}},[],import.meta.url);await e("home")}catch{console.log("Analytics tracking not available in development")}}}document.addEventListener("DOMContentLoaded",()=>{new $});
