...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Tf(n){Yt(new Dt("platform-logger",e=>new Dd(e),"PRIVATE")),Yt(new Dt("heartbeat",e=>new gf(e),"PRIVATE")),dt(si,Ia,n),dt(si,Ia,"esm2020"),dt("fire-js","")}Tf("");var bf="firebase",If="12.4.0";/**
* @license
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/dt(bf,If,"app");function eu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const _f=eu,tu=new Jn("auth","Firebase",eu());/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class bu{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem($s,"1"),this.storage.removeItem($s),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class _u extends bu{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}_u.type="SESSION";const Eu=_u;/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ft,Du;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,m){function y(){}y.prototype=m.prototype,T.F=m.prototype,T.prototype=new y,T.prototype.constructor=T,T.D=function(b,w,_){for(var g=Array(arguments.length-2),_e=2;_e<arguments.length;_e++)g[_e-2]=arguments[_e];return m.prototype[w].apply(b,g)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,t),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function r(T,m,y){y||(y=0);const b=Array(16);if(typeof m=="string")for(var w=0;w<16;++w)b[w]=m.charCodeAt(y++)|m.charCodeAt(y++)<<8|m.charCodeAt(y++)<<16|m.charCodeAt(y++)<<24;else for(w=0;w<16;++w)b[w]=m[y++]|m[y++]<<8|m[y++]<<16|m[y++]<<24;m=T.g[0],y=T.g[1],w=T.g[2];let _=T.g[3],g;g=m+(_^y&(w^_))+b[0]+3614090360&4294967295,m=y+(g<<7&4294967295|g>>>25),g=_+(w^m&(y^w))+b[1]+3905402710&4294967295,_=m+(g<<12&4294967295|g>>>20),g=w+(y^_&(m^y))+b[2]+606105819&4294967295,w=_+(g<<17&4294967295|g>>>15),g=y+(m^w&(_^m))+b[3]+3250441966&4294967295,y=w+(g<<22&4294967295|g>>>10),g=m+(_^y&(w^_))+b[4]+4118548399&4294967295,m=y+(g<<7&4294967295|g>>>25),g=_+(w^m&(y^w))+b[5]+1200080426&4294967295,_=m+(g<<12&4294967295|g>>>20),g=w+(y^_&(m^y))+b[6]+2821735955&4294967295,w=_+(g<<17&4294967295|g>>>15),g=y+(m^w&(_^m))+b[7]+4249261313&4294967295,y=w+(g<<22&4294967295|g>>>10),g=m+(_^y&(w^_))+b[8]+1770035416&4294967295,m=y+(g<<7&4294967295|g>>>25),g=_+(w^m&(y^w))+b[9]+2336552879&4294967295,_=m+(g<<12&4294967295|g>>>20),g=w+(y^_&(m^y))+b[10]+4294925233&4294967295,w=_+(g<<17&4294967295|g>>>15),g=y+(m^w&(_^m))+b[11]+2304563134&4294967295,y=w+(g<<22&4294967295|g>>>10),g=m+(_^y&(w^_))+b[12]+1804603682&4294967295,m=y+(g<<7&4294967295|g>>>25),g=_+(w^m&(y^w))+b[13]+4254626195&4294967295,_=m+(g<<12&4294967295|g>>>20),g=w+(y^_&(m^y))+b[14]+2792965006&4294967295,w=_+(g<<17&4294967295|g>>>15),g=y+(m^w&(_^m))+b[15]+1236535329&4294967295,y=w+(g<<22&4294967295|g>>>10),g=m+(w^_&(y^w))+b[1]+4129170786&4294967295,m=y+(g<<5&4294967295|g>>>27),g=_+(y^w&(m^y))+b[6]+3225465664&4294967295,_=m+(g<<9&4294967295|g>>>23),g=w+(m^y&(_^m))+b[11]+643717713&4294967295,w=_+(g<<14&4294967295|g>>>18),g=y+(_^m&(w^_))+b[0]+3921069994&4294967295,y=w+(g<<20&4294967295|g>>>12),g=m+(w^_&(y^w))+b[5]+3593408605&4294967295,m=y+(g<<5&4294967295|g>>>27),g=_+(y^w&(m^y))+b[10]+38016083&4294967295,_=m+(g<<9&4294967295|g>>>23),g=w+(m^y&(_^m))+b[15]+3634488961&4294967295,w=_+(g<<14&4294967295|g>>>18),g=y+(_^m&(w^_))+b[4]+3889429448&4294967295,y=w+(g<<20&4294967295|g>>>12),g=m+(w^_&(y^w))+b[9]+568446438&4294967295,m=y+(g<<5&4294967295|g>>>27),g=_+(y^w&(m^y))+b[14]+3275163606&4294967295,_=m+(g<<9&4294967295|g>>>23),g=w+(m^y&(_^m))+b[3]+4107603335&4294967295,w=_+(g<<14&4294967295|g>>>18),g=y+(_^m&(w^_))+b[8]+1163531501&4294967295,y=w+(g<<20&4294967295|g>>>12),g=m+(w^_&(y^w))+b[13]+2850285829&4294967295,m=y+(g<<5&4294967295|g>>>27),g=_+(y^w&(m^y))+b[2]+4243563512&4294967295,_=m+(g<<9&4294967295|g>>>23),g=w+(m^y&(_^m))+b[7]+1735328473&4294967295,w=_+(g<<14&4294967295|g>>>18),g=y+(_^m&(w^_))+b[12]+2368359562&4294967295,y=w+(g<<20&4294967295|g>>>12),g=m+(y^w^_)+b[5]+4294588738&4294967295,m=y+(g<<4&4294967295|g>>>28),g=_+(m^y^w)+b[8]+2272392833&4294967295,_=m+(g<<11&4294967295|g>>>21),g=w+(_^m^y)+b[11]+1839030562&4294967295,w=_+(g<<16&4294967295|g>>>16),g=y+(w^_^m)+b[14]+4259657740&4294967295,y=w+(g<<23&4294967295|g>>>9),g=m+(y^w^_)+b[1]+2763975236&4294967295,m=y+(g<<4&4294967295|g>>>28),g=_+(m^y^w)+b[4]+1272893353&4294967295,_=m+(g<<11&4294967295|g>>>21),g=w+(_^m^y)+b[7]+4139469664&4294967295,w=_+(g<<16&4294967295|g>>>16),g=y+(w^_^m)+b[10]+3200236656&4294967295,y=w+(g<<23&4294967295|g>>>9),g=m+(y^w^_)+b[13]+681279174&4294967295,m=y+(g<<4&4294967295|g>>>28),g=_+(m^y^w)+b[0]+3936430074&4294967295,_=m+(g<<11&4294967295|g>>>21),g=w+(_^m^y)+b[3]+3572445317&4294967295,w=_+(g<<16&4294967295|g>>>16),g=y+(w^_^m)+b[6]+76029189&4294967295,y=w+(g<<23&4294967295|g>>>9),g=m+(y^w^_)+b[9]+3654602809&4294967295,m=y+(g<<4&4294967295|g>>>28),g=_+(m^y^w)+b[12]+3873151461&4294967295,_=m+(g<<11&4294967295|g>>>21),g=w+(_^m^y)+b[15]+530742520&4294967295,w=_+(g<<16&4294967295|g>>>16),g=y+(w^_^m)+b[2]+3299628645&4294967295,y=w+(g<<23&4294967295|g>>>9),g=m+(w^(y|~_))+b[0]+4096336452&4294967295,m=y+(g<<6&4294967295|g>>>26),g=_+(y^(m|~w))+b[7]+1126891415&4294967295,_=m+(g<<10&4294967295|g>>>22),g=w+(m^(_|~y))+b[14]+2878612391&4294967295,w=_+(g<<15&4294967295|g>>>17),g=y+(_^(w|~m))+b[5]+4237533241&4294967295,y=w+(g<<21&4294967295|g>>>11),g=m+(w^(y|~_))+b[12]+1700485571&4294967295,m=y+(g<<6&4294967295|g>>>26),g=_+(y^(m|~w))+b[3]+2399980690&4294967295,_=m+(g<<10&4294967295|g>>>22),g=w+(m^(_|~y))+b[10]+4293915773&4294967295,w=_+(g<<15&4294967295|g>>>17),g=y+(_^(w|~m))+b[1]+2240044497&4294967295,y=w+(g<<21&4294967295|g>>>11),g=m+(w^(y|~_))+b[8]+1873313359&4294967295,m=y+(g<<6&4294967295|g>>>26),g=_+(y^(m|~w))+b[15]+4264355552&4294967295,_=m+(g<<10&4294967295|g>>>22),g=w+(m^(_|~y))+b[6]+2734768916&4294967295,w=_+(g<<15&4294967295|g>>>17),g=y+(_^(w|~m))+b[13]+1309151649&4294967295,y=w+(g<<21&4294967295|g>>>11),g=m+(w^(y|~_))+b[4]+4149444226&4294967295,m=y+(g<<6&4294967295|g>>>26),g=_+(y^(m|~w))+b[11]+3174756917&4294967295,_=m+(g<<10&4294967295|g>>>22),g=w+(m^(_|~y))+b[2]+718787259&4294967295,w=_+(g<<15&4294967295|g>>>17),g=y+(_^(w|~m))+b[9]+3951481745&4294967295,T.g[0]=T.g[0]+m&4294967295,T.g[1]=T.g[1]+(w+(g<<21&4294967295|g>>>11))&4294967295,T.g[2]=T.g[2]+w&4294967295,T.g[3]=T.g[3]+_&4294967295}s.prototype.v=function(T,m){m===void 0&&(m=T.length);const y=m-this.blockSize,b=this.C;let w=this.h,_=0;for(;_<m;){if(w==0)for(;_<=y;)r(this,T,_),_+=this.blockSize;if(typeof T=="string"){for(;_<m;)if(b[w++]=T.charCodeAt(_++),w==this.blockSize){r(this,b),w=0;break}}else for(;_<m;)if(b[w++]=T[_++],w==this.blockSize){r(this,b),w=0;break}}this.h=w,this.o+=m},s.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var m=1;m<T.length-8;++m)T[m]=0;m=this.o*8;for(var y=T.length-8;y<T.length;++y)T[y]=m&255,m/=256;for(this.v(T),T=Array(16),m=0,y=0;y<4;++y)for(let b=0;b<32;b+=8)T[m++]=this.g[y]>>>b&255;return T};function o(T,m){var y=l;return Object.prototype.hasOwnProperty.call(y,T)?y[T]:y[T]=m(T)}function a(T,m){this.h=m;const y=[];let b=!0;for(let w=T.length-1;w>=0;w--){const _=T[w]|0;b&&_==m||(y[w]=_,b=!1)}this.g=y}var l={};function h(T){return-128<=T&&T<128?o(T,function(m){return new a([m|0],m<0?-1:0)}):new a([T|0],T<0?-1:0)}function f(T){if(isNaN(T)||!isFinite(T))return v;if(T<0)return O(f(-T));const m=[];let y=1;for(let b=0;T>=y;b++)m[b]=T/y|0,y*=4294967296;return new a(m,0)}function p(T,m){if(T.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(T.charAt(0)=="-")return O(p(T.substring(1),m));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const y=f(Math.pow(m,8));let b=v;for(let _=0;_<T.length;_+=8){var w=Math.min(8,T.length-_);const g=parseInt(T.substring(_,_+w),m);w<8?(w=f(Math.pow(m,w)),b=b.j(w).add(f(g))):(b=b.j(y),b=b.add(f(g)))}return b}var v=h(0),C=h(1),k=h(16777216);n=a.prototype,n.m=function(){if(L(this))return-O(this).m();let T=0,m=1;for(let y=0;y<this.g.length;y++){const b=this.i(y);T+=(b>=0?b:4294967296+b)*m,m*=4294967296}return T},n.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(D(this))return"0";if(L(this))return"-"+O(this).toString(T);const m=f(Math.pow(T,6));var y=this;let b="";for(;;){const w=pe(y,m).g;y=$(y,w.j(m));let _=((y.g.length>0?y.g[0]:y.h)>>>0).toString(T);if(y=w,D(y))return _+b;for(;_.length<6;)_="0"+_;b=_+b}},n.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function D(T){if(T.h!=0)return!1;for(let m=0;m<T.g.length;m++)if(T.g[m]!=0)return!1;return!0}function L(T){return T.h==-1}n.l=function(T){return T=$(this,T),L(T)?-1:D(T)?0:1};function O(T){const m=T.g.length,y=[];for(let b=0;b<m;b++)y[b]=~T.g[b];return new a(y,~T.h).add(C)}n.abs=function(){return L(this)?O(this):this},n.add=function(T){const m=Math.max(this.g.length,T.g.length),y=[];let b=0;for(let w=0;w<=m;w++){let _=b+(this.i(w)&65535)+(T.i(w)&65535),g=(_>>>16)+(this.i(w)>>>16)+(T.i(w)>>>16);b=g>>>16,_&=65535,g&=65535,y[w]=g<<16|_}return new a(y,y[y.length-1]&-2147483648?-1:0)};function $(T,m){return T.add(O(m))}n.j=function(T){if(D(this)||D(T))return v;if(L(this))return L(T)?O(this).j(O(T)):O(O(this).j(T));if(L(T))return O(this.j(O(T)));if(this.l(k)<0&&T.l(k)<0)return f(this.m()*T.m());const m=this.g.length+T.g.length,y=[];for(var b=0;b<2*m;b++)y[b]=0;for(b=0;b<this.g.length;b++)for(let w=0;w<T.g.length;w++){const _=this.i(b)>>>16,g=this.i(b)&65535,_e=T.i(w)>>>16,bt=T.i(w)&65535;y[2*b+2*w]+=g*bt,K(y,2*b+2*w),y[2*b+2*w+1]+=_*bt,K(y,2*b+2*w+1),y[2*b+2*w+1]+=g*_e,K(y,2*b+2*w+1),y[2*b+2*w+2]+=_*_e,K(y,2*b+2*w+2)}for(T=0;T<m;T++)y[T]=y[2*T+1]<<16|y[2*T];for(T=m;T<2*m;T++)y[T]=0;return new a(y,0)};function K(T,m){for(;(T[m]&65535)!=T[m];)T[m+1]+=T[m]>>>16,T[m]&=65535,m++}function oe(T,m){this.g=T,this.h=m}function pe(T,m){if(D(m))throw Error("division by zero");if(D(T))return new oe(v,v);if(L(T))return m=pe(O(T),m),new oe(O(m.g),O(m.h));if(L(m))return m=pe(T,O(m)),new oe(O(m.g),m.h);if(T.g.length>30){if(L(T)||L(m))throw Error("slowDivide_ only works with positive integers.");for(var y=C,b=m;b.l(T)<=0;)y=Ie(y),b=Ie(b);var w=ae(y,1),_=ae(b,1);for(b=ae(b,2),y=ae(y,2);!D(b);){var g=_.add(b);g.l(T)<=0&&(w=w.add(y),_=g),b=ae(b,1),y=ae(y,1)}return m=$(T,w.j(m)),new oe(w,m)}for(w=v;T.l(m)>=0;){for(y=Math.max(1,Math.floor(T.m()/m.m())),b=Math.ceil(Math.log(y)/Math.LN2),b=b<=48?1:Math.pow(2,b-48),_=f(y),g=_.j(m);L(g)||g.l(T)>0;)y-=b,_=f(y),g=_.j(m);D(_)&&(_=C),w=w.add(_),T=$(T,g)}return new oe(w,T)}n.B=function(T){return pe(this,T).h},n.and=function(T){const m=Math.max(this.g.length,T.g.length),y=[];for(let b=0;b<m;b++)y[b]=this.i(b)&T.i(b);return new a(y,this.h&T.h)},n.or=function(T){const m=Math.max(this.g.length,T.g.length),y=[];for(let b=0;b<m;b++)y[b]=this.i(b)|T.i(b);return new a(y,this.h|T.h)},n.xor=function(T){const m=Math.max(this.g.length,T.g.length),y=[];for(let b=0;b<m;b++)y[b]=this.i(b)^T.i(b);return new a(y,this.h^T.h)};function Ie(T){const m=T.g.length+1,y=[];for(let b=0;b<m;b++)y[b]=T.i(b)<<1|T.i(b-1)>>>31;return new a(y,T.h)}function ae(T,m){const y=m>>5;m%=32;const b=T.g.length-y,w=[];for(let _=0;_<b;_++)w[_]=m>0?T.i(_+y)>>>m|T.i(_+y+1)<<32-m:T.i(_+y);return new a(w,T.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,Du=s,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=f,a.fromString=p,ft=a}).apply(typeof $a<"u"?$a:typeof self<"u"?self:typeof window<"u"?window:{});var _s=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
